package io.github.kirillka645.bleadvertiserpro.Services
...
import io.github.kirillka645.bleadvertiserpro.Enums.stringResId
...
import io.github.kirillka645.bleadvertiserpro.MainActivity
...
class AdvertisementForegroundService: IAdvertisementServiceCallback, IAdvertisementSetQueueHandlerCallback, Service() {
    ...
    override fun onCreate() {
        ...
        // Setup Callbacks
        val app = applicationContext as BleAdvertiserApplication
    ...
    class ToggleButtonListener : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            (context.applicationContext as BleAdvertiserApplication).queueHandler.toggle(context)
        }
    }

    class StopButtonListener : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            (context.applicationContext as BleAdvertiserApplication)
