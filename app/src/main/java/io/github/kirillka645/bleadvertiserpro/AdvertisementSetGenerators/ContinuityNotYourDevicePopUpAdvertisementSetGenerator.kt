...
class ContinuityNotYourDevicePopUpAdvertisementSetGenerator: IAdvertisementSetGenerator {
    ...
    val deviceData = mapOf(
        ...
        "2420" to "AirPods Pro 2 (USB-C)",
        "0A20" to "AirPods Max",
        "1F20" to "AirPods Max (USB-C)",
        // Beats
        "1020" to "Beats Flex",
    ...
    val deviceColorsMap = mapOf(
        ...
        "1F20" to colors_airpods_max,
        "0220" to colors_white,
        "0F20" to colors_white,
        "1320" to colors_white,
        "1420" to colors_white,
        "1920" to colors_white,
        "1B20" to colors_white,
        "2420" to colors_white,
        ...
        "1820" to colors_beats_solo_pro,
        "1D20" to colors_beats_flex,
    )
